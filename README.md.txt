...
You will need to have a copy of 7-Zip installed in order to build the project automatically.

==Folder Structure==
/dev/ - Source files 
/dev/SDOOM2/ - Source files for the SDOOM2.PK3 file, the Maps folder is split by author
